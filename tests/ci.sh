...
arduino-cli compile --verbose --libraries .. --fqbn 'mcci:stm32:mcci_catena_4551:lorawan_region=us915,opt=osstd,xserial=generic,upload_method=STLink,sysclk=pll32m' tests/raw-feather/raw-feather.ino
